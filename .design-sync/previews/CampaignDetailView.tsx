...
function img(w: number, h: number, bg: string, label: string) {
  const svg =
    `<svg xmlns='http://www.w3.org/2000/svg' width='${w}' height='${h}'><rect width='${w}' height='${h}' fill='${bg}'/><text x='50%' y='54%' font-family='Arial' font-size='${
      Math.round(h / 4)
    }' fill='white' text-anchor='middle' dominant-baseline='middle'>${label}</text></svg>`;
...
const detail = {
  ...
  stats: [
    {
      ...
      label: 'Ngân sách',
      value: '40 triệu',
      metaLabel: 'Đã dùng 58%',
      metaVariant: 'secondary' as const,
    ...
    },
    {
      ...
      label: 'Thời gian',
      value: '18 ngày',
      metaLabel: 'Còn 6 ngày',
      metaVariant: 'warning' as const,
  ...
  brief: {
    ...
    audience:
      'Nữ giới 18–30 tuổi tại các thành phố lớn, quan tâm chăm sóc da và mỹ phẩm thuần chay.',
    pdfBriefLabel: 'Xem brief đầy đủ (PDF)',
  },
  recentContent: [
    {
      id: 'ct1',
      thumbnailUrl: img(144, 144, '#e63946', 'Reel'),
      title: 'Unbox sữa rửa mặt Cocoon cà phê',
    ...
    {
      id: 'ct2',
      thumbnailUrl: img(144, 144, '#2a9d8f', 'Video'),
      title: 'Trải nghiệm 7 ngày dùng bí đao',

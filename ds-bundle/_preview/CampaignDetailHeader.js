var __dsPreview = (() => {
  ...
  // .design-sync/previews/CampaignDetailHeader.tsx
  var CampaignDetailHeader_exports = {};
  __export(CampaignDetailHeader_exports, {
    Active: () => Active,
    Closed: () => Closed,
    Draft: () => Draft
  });
  ...
  function Active() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width: 900 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ds_exports.CampaignDetailHeader,
      {
  ...
  return __toCommonJS(CampaignDetailHeader_exports);
})();

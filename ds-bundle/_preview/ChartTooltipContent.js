  ...
  var require_use_sync_external_store_shim_development = __commonJS({
    "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
      ...
      (function() {
        ...
        var React27 = require_react_shim(), objectIs = "function" === typeof Object.is ? Object.is : is3, useState11 = React27.useState, useEffect16 = React27.useEffect, useLayoutEffect7 = React27.useLayoutEffect, useDebugValue2 = React27.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
  ...
  var require_with_selector_development = __commonJS({
    "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
      ...
      (function() {
        ...
        "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
        var React27 = require_react_shim(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is3, useSyncExternalStore2 = shim.useSyncExternalStore, useRef15 = React27.useRef, useEffect16 = React27.useEffect, useMemo9 = React27.useMemo, useDebugValue2 = React27.useDebugValue;
  ...
  var require_use_sync_external_store_with_selector_development = __commonJS({
    "node_modules/use-sync-external-store/cjs/use-sync-external-store-with-selector.development.js"(exports) {
      ...
      (function() {
        ...
        "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
        var React27 = require_react_shim(), objectIs = "function" === typeof Object.is ? Object.is : is3, useSyncExternalStore2 = React27.useSyncExternalStore, useRef15 = React27.useRef, useEffect16 = React27.useEffect, useMemo9 = React27.useMemo, useDebugValue2 = React27.useDebugValue;
        exports.useSyncExternalStoreWithSelector = function(subscribe, getSnapshot, getServerSnapshot, selector, isEqual) {
          var instRef = useRef15(null);
          if (null === instRef.current) {
            var inst = { hasValue: false, value: null };
...
(See https://redux.js.org/faq/organizing-state#can-i-put-functions-promises-or-other-non-serializable-items-in-my-store-state)`);
  ...
  var prepareAutoBatched = () => (payload2) => ({
    payload: payload2,
    meta: {
  ...
  var createAsyncThunk = /* @__PURE__ */ (() => {
    function createAsyncThunk2(typePrefix, payloadCreator, options) {
      const fulfilled = createAction(typePrefix + "/fulfilled", (payload2, requestId, arg, meta) => ({
        payload: payload2,
        meta: {
          ...meta || {},
          arg,
      ...
      const rejected = createAction(typePrefix + "/rejected", (error, requestId, arg, payload2, meta) => ({
        payload: payload2,
  ...
  function getTooltipEntry(_ref4) {
    var tooltipEntrySettings = _ref4.tooltipEntrySettings, dataKey = _ref4.dataKey, payload2 = _ref4.payload, value = _ref4.value, name = _ref4.name;
  ...
  function parseTooltipPayloadItem(item) {
    ...
    var payload2 = "payload" in item ? item.payload : void 0;
  ...
  var selectActiveTooltipDataPoints = createSelector([selectActiveTooltipPayload], (payload2) => {
    if (payload2 == null) {
      return void 0;
    }
    var dataPoints = payload2.map((p) => p.payload).filter((p) => p != null);
  ...
  function SetErrorBarContext(props) {
    var children = props.children, rest = _objectWithoutProperties8(props, _excluded8);
  ...
  function GraphicalItemClipPath(_ref2) {
    ...
    return /* @__PURE__ */ React16.createElement("clipPath", {
  ...
  function BarRectangle(_ref2) {
    var option = _ref2.option, shapeProps = _objectWithoutProperties9(_ref2, _excluded9);
    return /* @__PURE__ */ React17.createElement(Shape, {
      option,
  ...
  var BarStackClipLayer = (_ref2) => {
    var index = _ref2.index, rest = _objectWithoutProperties10(_ref2, _excluded10);
    var clipPathUrl = useBarStackClipPathUrl(index);
    return /* @__PURE__ */ React18.createElement(Layer, _extends7({
  ...
  // node_modules/recharts/es6/cartesian/Bar.js
  var _excluded11 = ["onMouseEnter", "onMouseLeave", "onClick"];
  ...
  var SetBarTooltipEntrySettings = /* @__PURE__ */ React19.memo((_ref2) => {
    ...
    return /* @__PURE__ */ React19.createElement(SetTooltipEntrySettings, {
  ...
  function BarBackground(props) {
    ...
    var onMouseEnterFromProps = allOtherBarProps.onMouseEnter, onMouseLeaveFromProps = allOtherBarProps.onMouseLeave, onItemClickFromProps = allOtherBarProps.onClick, restOfAllOtherProps = _objectWithoutProperties11(allOtherBarProps, _excluded11);
    ...
    return /* @__PURE__ */ React19.createElement(ZIndexLayer, {
      ...
      var value = entry.value, backgroundFromDataEntry = entry.background, tooltipPosition = entry.tooltipPosition, rest = _objectWithoutProperties11(entry, _excluded26);
      ...
      var barRectangleProps = _objectSpread19(_objectSpread19(_objectSpread19(_objectSpread19(_objectSpread19({
      ...
      return /* @__PURE__ */ React19.createElement(BarRectangle, _extends8({
  ...
  function BarLabelListProvider(_ref2) {
    ...
    var labelListEntries = rects === null || rects === void 0 ? void 0 : rects.map((entry) => {
      ...
      return _objectSpread19(_objectSpread19({}, viewBox), {}, {
        value: entry.value,
    ...
    return /* @__PURE__ */ React19.createElement(CartesianLabelListContextProvider, {
  ...
  function BarRectangleWithActiveState(props) {
    ...
    var _useState = (0, import_react34.useState)(false), _useState2 = _slicedToArray14(_useState, 2), stayInLayer = _useState2[0], setStayInLayer = _useState2[1];
    var _useState3 = (0, import_react34.useState)(false), _useState4 = _slicedToArray14(_useState3, 2), hasMountedActive = _useState4[0], setHasMountedActive = _useState4[1];
    ...
    var content = /* @__PURE__ */ React19.createElement(BarRectangle, _extends8({}, baseProps, {
    ...
    if (shouldRenderInLayer) {
      ...
      }, /* @__PURE__ */ React19.createElement(BarStackClipLayer, {
  ...
  function BarRectangleNeverActive(props) {
    ...
    return /* @__PURE__ */ React19.createElement(BarRectangle, _extends8({}, baseProps, {
      name: String(baseProps.name)
    }, entry, {
      isActive: false,
      option: shape,
  ...
  function BarRectangles(_ref3) {
    ...
    var _ref4 = (_svgPropertiesNoEvent = svgPropertiesNoEvents(props)) !== null && _svgPropertiesNoEvent !== void 0 ? _svgPropertiesNoEvent : {}, id = _ref4.id, baseProps = _objectWithoutProperties11(_ref4, _excluded32);
    var shape = props.shape, dataKey = props.dataKey, activeBar = props.activeBar;
    var onMouseEnterFromProps = props.onMouseEnter, onItemClickFromProps = props.onClick, onMouseLeaveFromProps = props.onMouseLeave, restOfAllOtherProps = _objectWithoutProperties11(props, _excluded42);
    ...
    return /* @__PURE__ */ React19.createElement(React19.Fragment, null, data.map((entry, i) => {
      return /* @__PURE__ */ React19.createElement(BarStackClipLayer, _extends8({
        index: entry.originalDataIndex,
      ...
      }), activeBar ? /* @__PURE__ */ React19.createElement(BarRectangleWithActiveState, {
        shape,
        activeBar,
        baseProps,
        entry,
         ...
         */
        /* @__PURE__ */ React19.createElement(BarRectangleNeverActive, {
          shape,
          baseProps,
          entry,
          index: i,
  ...
  var defaultBarAnimateItems = (items, animationElapsedTime, layout) => {
    ...
    return items.flatMap((item) => {
      if (item.status === "removed") {
        if (layout === "horizontal") {
          return [_objectSpread19(_objectSpread19({}, item.prev), {}, {
      ...
      if (item.status === "matched") {
        return [_objectSpread19(_objectSpread19({}, item.next), {}, {
      ...
      var next = item.next;
      if (layout === "horizontal") {
        return [_objectSpread19(_objectSpread19({}, next), {}, {
  ...
  function RectanglesWithAnimation(_ref5) {
    ...
    return /* @__PURE__ */ React19.createElement(BarLabelListProvider, {
      showLabels: !isAnimating,
      rects: data
    }, /* @__PURE__ */ React19.createElement(AnimatedItems, {
      animationInput: data,
      ...
      layout
    }, (stepData, animationElapsedTime, isEntrance) => /* @__PURE__ */ React19.createElement(Layer, null, /* @__PURE__ */ React19.createElement(BarRectangles, {
      props,
      data: stepData,
      animationElapsedTime,
      isAnimating: isAnimating || animationElapsedTime < 1,
      isEntrance
    }))), /* @__PURE__ */ React19.createElement(LabelListFromLabelProp, {
      label: props.label
    }), props.children);
  }
  function RenderRectangles(props) {
    var previousRectanglesRef = (0, import_react34.useRef)(null);
    return /* @__PURE__ */ React19.createElement(RectanglesWithAnimation, {
  ...
  var BarWithState = class extends import_react34.PureComponent {
    render() {
      ...
      return /* @__PURE__ */ React19.createElement(Layer, {
        className: layerClass,
        id
      }, needClip && /* @__PURE__ */ React19.createElement("defs", null, /* @__PURE__ */ React19.createElement(GraphicalItemClipPath, {
        clipPathId,
        xAxisId,
        yAxisId
      })), /* @__PURE__ */ React19.createElement(Layer, {
        className: "recharts-bar-rectangles",
        clipPath: needClip ? "url(#clipPath-".concat(clipPathId, ")") : void 0
      }, /* @__PURE__ */ React19.createElement(BarBackground, {
        data,
        dataKey,
        background,
        allOtherBarProps: this.props
      }), /* @__PURE__ */ React19.createElement(RenderRectangles, this.props)));
    }
  };
  var defaultBarProps = {
    activeBar: false,
  ...
  function BarImpl(props) {
    ...
    return /* @__PURE__ */ React19.createElement(SetErrorBarContext, {
      xAxisId,
      yAxisId,
      data: rects,
      dataPointFormatter: errorBarDataPointFormatter,
      errorBarOffset
    }, /* @__PURE__ */ React19.createElement(BarWithState, _extends8({}, props, {
      layout,
      needClip,
      data: rects,
      xAxisId,
  ...
  function computeBarRectangles(_ref6) {
    ...
    return displayedData.map((entry, index) => {
      ...
      var barRectangleItem = _objectSpread19(_objectSpread19({}, entry), {}, {
        stackedBarStart,
        x,
        y,
        width,
  ...
  function BarFn(outsideProps) {
    ...
    var isPanorama = useIsPanorama();
    return /* @__PURE__ */ React19.createElement(RegisterGraphicalItemId, {
      id: props.id,
      type: "bar"
    }, (id) => /* @__PURE__ */ React19.createElement(React19.Fragment, null, /* @__PURE__ */ React19.createElement(SetLegendPayload, {
      legendPayload: computeLegendPayloadFromBarData(props)
    }), /* @__PURE__ */ React19.createElement(SetBarTooltipEntrySettings, {
    ...
    }), /* @__PURE__ */ React19.createElement(ZIndexLayer, {
      zIndex: props.zIndex
    }, /* @__PURE__ */ React19.createElement(BarImpl, _extends8({}, props, {
      id
    })))));
  }
  var Bar = /* @__PURE__ */ React19.memo(BarFn, propsAreEqual);
  Bar.displayName = "Bar";
  ...
  function RechartsStoreProvider(_ref2) {
    ...
    var isPanorama = useIsPanorama();
    var storeRef = (0, import_react35.useRef)(null);
    if (isPanorama) {
      return children;
    }
    ...
    return /* @__PURE__ */ React20.createElement(Provider_default, {
  ...
  var ReportMainChartProps = /* @__PURE__ */ (0, import_react36.memo)(ReportMainChartPropsImpl, propsAreEqual);
  ...
  var ReportEventSettings = /* @__PURE__ */ (0, import_react38.memo)(ReportEventSettingsImpl, propsAreEqual);
  ...
  function AllZIndexPortals(_ref2) {
    ...
    return /* @__PURE__ */ React21.createElement(React21.Fragment, null, allNegativeZIndexes.map((zIndex) => /* @__PURE__ */ React21.createElement(ZIndexSvgPortal, {
      key: zIndex,
      zIndex,
      isPanorama
    })), children, allPositiveZIndexes.map((zIndex) => /* @__PURE__ */ React21.createElement(ZIndexSvgPortal, {
      key: zIndex,
      zIndex,
      isPanorama
    })));
  ...
  var MainChartSurface = /* @__PURE__ */ (0, import_react40.forwardRef)((props, ref) => {
    ...
    return /* @__PURE__ */ React22.createElement(Surface, _extends9({}, otherAttributes, {
      title,
      desc,
      role,
      tabIndex,
  ...
  var BrushPanoramaSurface = (_ref2) => {
    ...
    return /* @__PURE__ */ React22.createElement(Surface, {
      width,
      height,
      x,
      y
  ...
  var RootSurface = /* @__PURE__ */ (0, import_react40.forwardRef)((_ref2, ref) => {
    var children = _ref2.children, rest = _objectWithoutProperties12(_ref2, _excluded12);
    var isPanorama = useIsPanorama();
    if (isPanorama) {
      return /* @__PURE__ */ React22.createElement(BrushPanoramaSurface, null, /* @__PURE__ */ React22.createElement(AllZIndexPortals, {
        isPanorama: true
      }, children));
    }
    return /* @__PURE__ */ React22.createElement(MainChartSurface, _extends9({
      ref
    }, rest), /* @__PURE__ */ React22.createElement(AllZIndexPortals, {
      isPanorama: false
    }, children));
  });
  ...
  function useReportScale() {
    var dispatch = useAppDispatch();
    var _useState = (0, import_react41.useState)(null), _useState2 = _slicedToArray15(_useState, 2), ref = _useState2[0], setRef = _useState2[1];
  ...
  var ResponsiveDiv = /* @__PURE__ */ (0, import_react42.forwardRef)((props, ref) => {
    var _props$style, _props$style2;
    var observerRef = (0, import_react42.useRef)(null);
    var _useState = (0, import_react42.useState)({
    ...
    }), _useState2 = _slicedToArray16(_useState, 2), sizes = _useState2[0], setSizes = _useState2[1];
    var setContainerSize = (0, import_react42.useCallback)((newWidth, newHeight) => {
      setSizes((prevState) => {
    ...
    return /* @__PURE__ */ React23.createElement(React23.Fragment, null, /* @__PURE__ */ React23.createElement(ReportChartSize, {
      width: sizes.containerWidth,
      height: sizes.containerHeight
    }), /* @__PURE__ */ React23.createElement("div", _extends10({
      ref: innerRef
    }, props)));
  });
  var ReadSizeOnceDiv = /* @__PURE__ */ (0, import_react42.forwardRef)((props, ref) => {
    var width = props.width, height = props.height;
    var _useState3 = (0, import_react42.useState)({
      containerWidth: getNumberOrZero(width),
      containerHeight: getNumberOrZero(height)
    }), _useState4 = _slicedToArray16(_useState3, 2), sizes = _useState4[0], setSizes = _useState4[1];
    var setContainerSize = (0, import_react42.useCallback)((newWidth, newHeight) => {
      setSizes((prevState) => {
        var roundedWidth = Math.round(newWidth);
        var roundedHeight = Math.round(newHeight);
  ...
  var StaticDiv = /* @__PURE__ */ (0, import_react42.forwardRef)((props, ref) => {
    var width = props.width, height = props.height;
    return /* @__PURE__ */ React23.createElement(React23.Fragment, null, /* @__PURE__ */ React23.createElement(ReportChartSize, {
      width,
      height
  ...
  var NonResponsiveDiv = /* @__PURE__ */ (0, import_react42.forwardRef)((props, ref) => {
    var width = props.width, height = props.height;
    if (typeof width === "string" || typeof height === "string") {
      return /* @__PURE__ */ React23.createElement(ReadSizeOnceDiv, _extends10({}, props, {
        ref
      }));
    }
    if (typeof width === "number" && typeof height === "number") {
      return /* @__PURE__ */ React23.createElement(StaticDiv, _extends10({}, props, {
        width,
        height,
        ref
      }));
  ...
  var RechartsWrapper = /* @__PURE__ */ (0, import_react42.forwardRef)((props, ref) => {
    ...
    var dispatch = useAppDispatch();
    var _useState5 = (0, import_react42.useState)(null), _useState6 = _slicedToArray16(_useState5, 2), tooltipPortal = _useState6[0], setTooltipPortal = _useState6[1];
    var _useState7 = (0, import_react42.useState)(null), _useState8 = _slicedToArray16(_useState7, 2), legendPortal = _useState8[0], setLegendPortal = _useState8[1];
    ...
    var onBlur = (0, import_react42.useCallback)(() => {
      dispatch(blurAction());
    }, [dispatch]);
    ...
    return /* @__PURE__ */ React23.createElement(TooltipPortalContext.Provider, {
      value: tooltipPortal
    }, /* @__PURE__ */ React23.createElement(LegendPortalContext.Provider, {
      value: legendPortal
    }, /* @__PURE__ */ React23.createElement(WrapperDiv, {
      ...
      ref: innerRef
    }, /* @__PURE__ */ React23.createElement(EventSynchronizer, null), children)));
  });

  // node_modules/recharts/es6/chart/CategoricalChart.js
  var _excluded13 = ["width", "height", "responsive", "children", "className", "style", "compact", "title", "desc"];
  ...
  var CategoricalChart = /* @__PURE__ */ (0, import_react43.forwardRef)((props, ref) => {
    var width = props.width, height = props.height, responsive = props.responsive, children = props.children, className = props.className, style = props.style, compact = props.compact, title = props.title, desc = props.desc, others = _objectWithoutProperties13(props, _excluded13);
    var attrs = svgPropertiesNoEvents(others);
    if (compact) {
      return /* @__PURE__ */ React24.createElement(React24.Fragment, null, /* @__PURE__ */ React24.createElement(ReportChartSize, {
        width,
        height
      }), /* @__PURE__ */ React24.createElement(RootSurface, {
        otherAttributes: attrs,
        title,
        desc
      }, children));
    }
    return /* @__PURE__ */ React24.createElement(RechartsWrapper, {
      className,
      style,
      width,
      height,
      ...
      desc,
      ref
    }, /* @__PURE__ */ React24.createElement(ClipPathProvider, null, children)));
  });
  ...
  var defaultCartesianChartProps = _objectSpread21({
    accessibilityLayer: true,
    barCategoryGap: "10%",
    barGap: 4,
    layout: "horizontal",
  ...
  var CartesianChart = /* @__PURE__ */ (0, import_react44.forwardRef)(function CartesianChart2(props, ref) {
    ...
    return /* @__PURE__ */ React25.createElement(RechartsStoreProvider, {
      preloadedState: {
        options
      },
      reduxStoreName: (_categoricalChartProp = categoricalChartProps.id) !== null && _categoricalChartProp !== void 0 ? _categoricalChartProp : chartName
    }, /* @__PURE__ */ React25.createElement(ChartDataContextProvider, {
      chartData: categoricalChartProps.data
    }), /* @__PURE__ */ React25.createElement(ReportMainChartProps, {
      layout: rootChartProps.layout,
      margin: rootChartProps.margin
    }), /* @__PURE__ */ React25.createElement(ReportEventSettings, {
      throttleDelay: rootChartProps.throttleDelay,
      throttledEvents: rootChartProps.throttledEvents
    }), /* @__PURE__ */ React25.createElement(ReportChartProps, {
    ...
    }), /* @__PURE__ */ React25.createElement(CategoricalChart, _extends11({}, rootChartProps, {
      ref
    })));
  });
  ...
  var BarChart = /* @__PURE__ */ (0, import_react45.forwardRef)((props, ref) => {
    return /* @__PURE__ */ React26.createElement(CartesianChart, {
      chartName: "BarChart",
      defaultTooltipEventType: "axis",
  ...
  var payload = [
    { dataKey: "reach", name: "reach", value: 124e4, color: "#f59e0b" },
    { dataKey: "engagement", name: "engagement", value: 186400, color: "#3b82f6" }
  ];
  var fmt = (v) => new Intl.NumberFormat("vi-VN", { notation: "compact", maximumFractionDigits: 1 }).format(Number(v));
  function Frame({ children }) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(ds_exports.ChartContainer, { config, className: "!block h-auto w-full", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BarChart, { width: 1, height: 1, data: [{ reach: 1 }], children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bar, { dataKey: "reach" }) }),
      children
    ] });
  }
  function Dot() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width: 240, padding: 24 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Frame, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "inline-block" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ds_exports.ChartTooltipContent,
      {
        active: true,
        label: "TikTok",
        indicator: "dot",

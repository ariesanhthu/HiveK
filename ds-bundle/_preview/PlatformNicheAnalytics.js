var __dsPreview = (() => {
  ...
  // .design-sync/previews/PlatformNicheAnalytics.tsx
  var PlatformNicheAnalytics_exports = {};
  __export(PlatformNicheAnalytics_exports, {
    Default: () => Default
  });
  init_define_import_meta_env();
  ...
  var scatterPoints = [
    ...
    { name: "Hoàng Long", niche: "Công nghệ", engagementQuality: 62, kolScore: 70.2, followers: 245e3 }
  ];
  var audienceTree = [
  ...
  function Default() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width: 1080 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ds_exports.PlatformNicheAnalytics,
      {
        platformScores,
        nicheEngagement,
        scatterPoints,
  ...
  return __toCommonJS(PlatformNicheAnalytics_exports);
})();

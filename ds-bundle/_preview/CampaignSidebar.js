var __dsPreview = (() => {
  ...
  // .design-sync/previews/CampaignSidebar.tsx
  var CampaignSidebar_exports = {};
  __export(CampaignSidebar_exports, {
  ...
  function ReadyToPlan() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width: 360, display: "flex", flexDirection: "column", gap: 16 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ds_exports.CampaignSidebar,
      {
        campaign,
        validationMessages: [],
        participantCount: 6,
  ...
  return __toCommonJS(CampaignSidebar_exports);
})();

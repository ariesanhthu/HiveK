var __dsPreview = (() => {
  ...
  // .design-sync/previews/CreatorSuggestionsTab.tsx
  var CreatorSuggestionsTab_exports = {};
  __export(CreatorSuggestionsTab_exports, {
    Default: () => Default
  });
  init_define_import_meta_env();
  ...
  function Default() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width: 860 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ds_exports.CreatorSuggestionsTab,
      {
        campaign,
        suggestions,
  ...
  return __toCommonJS(CreatorSuggestionsTab_exports);
})();

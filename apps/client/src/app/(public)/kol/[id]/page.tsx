...
function mapRankingToCertificate(kol: KolRankingItem): KolVerificationCertificate {
  ...
  return {
    ...
    partnerFeedback: [
      ...
      {
        id: 'fb-b',
        quote: 'Audience quality exceeded benchmarks; reporting was transparent and on schedule.',
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description:
      `Chứng nhận xác minh creator ${kol.name}: hạng #${kol.rank}, ${kol.platform}, lĩnh vực ${kol.niche}.`,
    openGraph: {

  ...
  return (
    <div className="w-full max-w-md" style={{ "--auth-accent": ACCENT } as React.CSSProperties}>
      ...
      <div
        ...
        style={{
          background: `linear-gradient(165deg, color-mix(in srgb, ${ACCENT} 50%, transparent) 0%, rgba(255,255,255,0.10) 30%, rgba(255,255,255,0.06) 62%, color-mix(in srgb, ${ACCENT} 28%, transparent) 100%)`,
        }}
      >
        <div
        ...
        >
          <span
            ...
            style={{
              background: `linear-gradient(90deg, transparent, color-mix(in srgb, ${ACCENT} 75%, white), transparent)`,
            }}
            aria-hidden
          />
          ...
          >
            <span className="material-symbols-outlined text-2xl" style={{ color: ACCENT }} aria-hidden>
              mark_email_unread
            </span>
          </span>

          <p className="text-sm leading-relaxed text-white/55">
            Liên kết đặt lại mật khẩu chỉ dùng được một lần và có thời hạn sử dụng.
            Trong lúc chờ tính năng mở, hãy liên hệ đội ngũ Hive-K nếu bạn mất quyền truy cập.
          </p>

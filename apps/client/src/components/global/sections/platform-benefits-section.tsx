      ...
      <div className='mx-auto max-w-7xl px-6'>
        <div className='mb-16 flex flex-col items-center text-center'>
          ...
          <p className='mt-4 max-w-2xl text-foreground-muted'>
            Chúng tôi đơn giản hóa việc kết nối giữa KOL và các thương hiệu hàng đầu, tập trung vào
            tăng trưởng và tương tác thực chất.
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 gap-8 md:grid-cols-3'>
          <div className='group rounded-[2rem] bg-white p-10 shadow-[0_8px_30px_rgb(0,0,0,0.06)] transition-all hover:-translate-y-1 hover:shadow-xl dark:bg-card'>
            ...
            <p className='text-base leading-relaxed text-foreground-muted'>
              AI gợi ý thương hiệu phù hợp với tệp khán giả riêng của bạn để tạo nên các chiến dịch
              hoàn hảo.
            </p>
          </div>
          ...
          <div className='group rounded-[2rem] bg-white p-10 shadow-[0_8px_30px_rgb(0,0,0,0.06)] transition-all hover:-translate-y-1 hover:shadow-xl dark:bg-card'>
            ...
            <p className='text-base leading-relaxed text-foreground-muted'>
              Bảng điều khiển toàn diện giúp theo dõi lượng tương tác, sự phát triển khán giả và ROI
              chiến dịch ngay lập tức.
            </p>
          </div>
          ...
          <div className='group rounded-[2rem] bg-white p-10 shadow-[0_8px_30px_rgb(0,0,0,0.06)] transition-all hover:-translate-y-1 hover:shadow-xl dark:bg-card'>
            ...
            <p className='text-base leading-relaxed text-foreground-muted'>
              Hệ thống thanh toán đảm bảo (escrow) giúp bạn nhận tiền đúng hạn ngay khi đạt đủ mốc
              yêu cầu của chiến dịch.
            </p>
          </div>
        </div>
      </div>

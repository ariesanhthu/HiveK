      ...
      <div className="relative overflow-hidden rounded-[2.5rem] bg-background-dark p-8 text-center text-on-dark md:p-16">
        ...
        <div className="relative z-10 mx-auto max-w-3xl">
          <h2 className="text-4xl font-black md:text-5xl">
            Sẵn sàng đưa sự nghiệp gia sư của bạn lên tầm cao mới?
          </h2>
          <p className="mt-6 text-lg text-on-dark-muted">
            Gia nhập cộng đồng cộng tác viên & gia sư ưu tú và bắt đầu kết nối với các đối tác giáo dục, homestay ngay hôm nay.
          </p>

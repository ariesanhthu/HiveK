          ...
          <div key={c.name} className="rounded-2xl border border-primary-soft bg-card p-3.5">
            <div className="flex items-start justify-between gap-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className={`rounded-full border px-2 py-0.5 text-[9px] font-bold ${TONE_CLASS[c.tone]}`}>
                      {c.status}
                    </span>
                  </div>
                  ...
                  <div className="mt-1.5 flex gap-1.5">
                    {c.platforms.map((p) => (
                      <span key={p} className="rounded-full border border-primary-soft bg-muted px-2 py-0.5 text-[9px] font-semibold text-foreground-muted">
                        {p}
                      </span>
                    ))}
                  </div>
              ...
              <div className="grid shrink-0 grid-cols-3 gap-2 text-center">
                ...
                <div>
                  <p className="text-sm font-black text-tech-blue" style={{ color: "var(--color-tech-blue)" }}>{c.scheduled}</p>

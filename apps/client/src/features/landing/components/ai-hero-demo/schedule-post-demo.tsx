...
export function SchedulePostDemo({ active }: { active: boolean; }) {
  ...
  const igPillStyle: React.CSSProperties = state.igSelected
    ? {
      ...
      color: '#e8759e',
      border: '1.5px solid rgba(214,41,118,0.35)',
    }
    : {
      background: 'rgba(255,255,255,0.06)',
      color: '#94a3b8',
            ...
            <div className='flex flex-col items-center gap-4.5'>
                ...
                <div>
                  ...
                  <div className='flex w-[220px] flex-col gap-2.5'>
                    <div className='flex items-center gap-2.5'>
                      <span
                        className={`material-symbols-outlined text-[18px] ${
                          state.fbPosted ? 'text-emerald-400' : 'animate-spin text-slate-500'
                        }`}
                        aria-hidden
                      >
                    ...
                    <div className='flex items-center gap-2.5'>
                      <span
                        className={`material-symbols-outlined text-[18px] ${
                          state.igPosted ? 'text-emerald-400' : 'animate-spin text-slate-500'
                        }`}
                        aria-hidden
                      >
              ...
              {isLoading && state.loadingDone && (
                <div className='flex flex-col items-center gap-3'>
                  <span
                    className='material-symbols-outlined text-[60px] text-emerald-500'
                    aria-hidden
                  >
                    check_circle
                  </span>
                  ...
                  >
                    ...
                    <div className='min-w-0 flex-1'>
                      <div className='flex justify-between gap-1.5'>
                        <span className='text-[0.66rem] font-extrabold text-neutral-900'>
                          Facebook
                        </span>

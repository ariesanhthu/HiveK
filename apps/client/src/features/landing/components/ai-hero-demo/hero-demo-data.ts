...
export const BOT_INTRO_TEXT = 'Chào bạn! Điền thông tin dưới đây để mình khởi tạo Hive-K cho bạn:';
export const BRAND_NAME = 'Coffee House';
export const POST_TEXT = 'Ưu đãi cuối tuần – giảm 30% toàn bộ sản phẩm, áp dụng đến Chủ Nhật.';

...
import {
  GALAXY_FEATURES,
  type GalaxyFeatureId,
} from '@/features/landing/components/feature-galaxy/galaxy-data';
      ...
      <div className='relative mx-auto w-full max-w-[1400px] px-6'>
        ...
        >
          ...
          <h2 className='mt-4 text-3xl font-black tracking-tight text-foreground md:text-5xl'>
            Mọi tính năng, xoay quanh <span className='text-primary'>chiến dịch của bạn</span>
          </h2>
          <p className='mt-4 text-base leading-relaxed text-foreground-muted'>
            Từ ghép đôi AI đến chi trả an toàn — chọn một tính năng để xem demo trực tiếp hệ sinh
            thái Hive-K.
          </p>
        </motion.div>
              ...
              return (
                ...
                >
                  <span
                    ...
                    style={{
                      background:
                        `linear-gradient(135deg, color-mix(in srgb, ${feature.color} 30%, transparent), color-mix(in srgb, ${feature.color} 10%, transparent))`,
              ...
              >
                ...
                <div className='mx-3 mb-4 mt-1 overflow-hidden rounded-xl border border-black/20 bg-background-light shadow-2xl dark:bg-background-dark sm:mx-6 sm:mb-7'>
                  ...
                  <div className='flex items-center gap-2 border-b border-primary-soft bg-card px-3 py-2 sm:gap-3'>
                    ...
                    <div
                      className='hidden items-center gap-1 text-foreground-muted sm:flex'
                      aria-hidden
                    >
                    ...
                    <div
                      className='hidden items-center gap-2 text-foreground-muted sm:flex'
                      aria-hidden
                    >

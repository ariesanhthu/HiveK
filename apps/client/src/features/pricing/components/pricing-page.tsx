...
function CellValue({ value, color }: { value: string | boolean; color: string; }) {
  ...
  return value
    ...
    : (
      <span
        className='material-symbols-outlined text-xl text-foreground-muted/40'
        aria-label='Không'
      >
        remove
      </span>
    ...
    >
      ...
      <div className='flex items-center gap-3'>
        <span
          ...
          style={{
            background:
              `linear-gradient(135deg, color-mix(in srgb, ${plan.color} 30%, transparent), color-mix(in srgb, ${plan.color} 10%, transparent))`,
    ...
    <div className='pb-24 pt-32 md:pt-40'>
      ...
      >
        ...
        <p className='mt-4 text-base leading-relaxed text-foreground-muted'>
          Bắt đầu miễn phí, nâng cấp khi tăng trưởng. Creator tham gia nền tảng hoàn toàn miễn phí.
        </p>
      ...
      >
        <div className='relative overflow-hidden rounded-3xl border border-primary-soft bg-card p-10 text-center sm:p-14'>
          ...
          <p className='relative mx-auto mt-3 max-w-xl text-sm leading-relaxed text-foreground-muted'>
            Dùng thử Growth 14 ngày miễn phí — hoặc để đội ngũ Hive-K tư vấn giải pháp theo ngân
            sách và ngành hàng của bạn.
          </p>

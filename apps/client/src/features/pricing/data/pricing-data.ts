...
export const COMPARISON_GROUPS: { title: string; icon: string; rows: ComparisonRow[] }[] = [
  {
    ...
    icon: "auto_awesome",
    rows: [
      { label: "Lượt ghép đôi AI / tháng", starter: "3", growth: "Không giới hạn", enterprise: "Không giới hạn" },
  ...
  },
  {
    ...
    icon: "campaign",
    rows: [
      { label: "Chiến dịch chạy đồng thời", starter: "1", growth: "10", enterprise: "Không giới hạn" },
  ...
  },
  {
    ...
    icon: "monitoring",
    rows: [
      { label: "Bảng điều khiển thời gian thực", starter: "Cơ bản", growth: true, enterprise: true },

    ...
    <>
      ...
      <div className='flex flex-col flex-1 p-5'>
        <div className='mb-3 flex flex-wrap items-center gap-2'>
          <Badge
            variant='outline'
            className='border-primary/20 bg-background px-2.5 py-0.5 text-[11px] font-semibold text-primary transition-colors group-hover:bg-primary/5'
          >
            {category}
          </Badge>
          <Badge
            variant={statusVariant}
            className='px-2.5 py-0.5 text-[11px] font-semibold shadow-none'
          >
            {statusLabel}
          </Badge>
        </div>

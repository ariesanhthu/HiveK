  ...
  conversation({
    ...
    messages: [
      message(
        ...
        'customer',
        'Minh Anh',
        'Mình cần tìm gia sư Toán lớp 8, học tại nhà ở Phú Nhuận.',
        '2026-07-15T09:18:00+07:00',
      ),
      message(
        'm2',
        'ai_agent',
        'AI Agent',
        'Mình đã tìm được 3 gia sư phù hợp lịch tối thứ 3 và thứ 5. Mình đang kiểm tra lại học phí trước khi gửi bạn.',
        '2026-07-15T09:19:00+07:00',
        {
          isAutomated: true,
          confidence: 'high',
      ...
      message(
        ...
        'customer',
        'Minh Anh',
        'Phí là 180 nghìn hay 220 nghìn một buổi vậy bạn?',
        '2026-07-15T09:22:00+07:00',
      ),
      message(
        'm4',
        'system',
        'Hệ thống',
        'AI đã dừng và chuyển cho người thật do bảng phí gia sư đang mâu thuẫn.',
        '2026-07-15T09:22:10+07:00',
      ),
    ],
  }),
  conversation({
    ...
    messages: [
      message(
        ...
        'customer',
        'Thảo Vy',
        'Mình muốn tìm gia sư nữ dạy IELTS cho em lớp 11, bên bạn tư vấn giúp mình nhé.',
        '2026-07-15T08:54:00+07:00',
      ),
    ],
  }),
  conversation({
    ...
    messages: [
      message(
        ...
        'customer',
        'Quốc Huy',
        'Có gia sư Vật lý lớp 10 học tối thứ 2, 4 không?',
      ...
      message(
        ...
        'ai_agent',
        'AI Agent',
        'Có 2 gia sư tại Cầu Giấy phù hợp lịch tối thứ 2, 4. Bạn muốn mình gửi hồ sơ để chọn buổi học thử không?',
        '2026-07-15T08:31:00+07:00',
        {
          isAutomated: true,
          confidence: 'high',
  ...
  conversation({
    ...
    messages: [
      message(
        ...
        'customer',
        'Linh Chi',
        'Em thấy lớp Toán 9 ở Đà Lạt, lớp còn tuyển gia sư không ạ?',
        '2026-07-15T08:12:00+07:00',
      ),
    ],
  }),
  conversation({
    ...
    messages: [
      message(
        ...
        'customer',
        'Gia Bảo',
        'Em là sinh viên Sư phạm Hóa, hiện có job dạy Hóa cấp 3 ở Cần Thơ không ạ?',
        '2026-07-15T07:48:00+07:00',
      ),
    ],
  }),
  conversation({
    ...
    messages: [
      message(
        ...
        'customer',
        'Hoàng Nam',
        'Mình đã đóng phí nhận lớp nhưng phụ huynh đổi lịch, bên bạn hỗ trợ giúp mình nhé.',
        '2026-07-14T22:10:00+07:00',
      ),
    ],
  }),
  conversation({
    ...
    messages: [
      message(
        ...
        'customer',
        'Khánh Ly',
        'Gia sư Nguyễn Thu Hà có kinh nghiệm dạy học sinh lớp 6 chưa?',
        '2026-07-14T20:22:00+07:00',
      ),
      message(
        'm12',
        'ai_agent',
        'AI Agent',
        'Bạn Hà có 2 năm dạy Tiếng Anh THCS và đã hoàn thành 18 lớp trên HIVE-K với đánh giá 4,9/5.',
        '2026-07-14T20:23:00+07:00',
        {
          isAutomated: true,
          confidence: 'high',
          evidence: ['Hồ sơ gia sư Nguyễn Thu Hà · đã xác minh'],
        },
      ),
    ],
  }),
  conversation({
    ...
    messages: [
      message(
        ...
        'customer',
        'Tú Uyên',
        'Bên mình có lớp Ngữ văn cấp 2 ở Huế cần gia sư không ạ?',
        '2026-07-14T18:45:00+07:00',
      ),
    ],
  }),
  conversation({
    ...
    messages: [
      message(
        ...
        'customer',
        'Bảo Trân',
        'Hồ sơ ứng tuyển lớp Tiếng Anh 8 của mình đã được phụ huynh xem chưa ạ?',
        '2026-07-14T17:12:00+07:00',
      ),
    ],
  }),
  conversation({
    ...
    messages: [
      message(
        ...
        'ai_agent',
        'AI Agent',
        'Bạn đăng ký hồ sơ gia sư tại hivek.vn/gia-su/dang-ky, sau đó tải lên thẻ sinh viên và bằng cấp liên quan nhé.',
        '2026-07-14T15:05:00+07:00',
        { isAutomated: true },
      ),
    ],
  }),
  conversation({
    ...
    messages: [
      message(
        ...
        'current_user',
        'Anh Thư',
        'Mình đã giữ lớp Tiếng Việt lớp 3 đến 18:00 hôm nay để bạn xác nhận lịch nhé.',
        '2026-07-14T14:40:00+07:00',
      ),
    ],
  }),
  conversation({
    ...
    messages: [
      message(
        ...
        'ai_agent',
        'AI Agent',
        'Sau khi hồ sơ được xác minh, bạn sẽ có một buổi dạy thử 20 phút trước khi nhận lớp chính thức.',
        '2026-07-13T16:20:00+07:00',
        {
          isAutomated: true,
          confidence: 'high',
          evidence: ['Quy trình nhận lớp gia sư · phiên bản 3'],
        },
      ),
    ],
  }),

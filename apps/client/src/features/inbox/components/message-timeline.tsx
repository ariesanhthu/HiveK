import { AlertTriangle, Bot, CheckCheck, Info, StickyNote, UserRound, UserRoundCheck } from "lucide-react";
      ...
      >
        ...
        {message.evidence?.length ? (
          <details className="mt-2 border-t border-amber-200 pt-2 text-xs text-amber-900">
            ...
            <p className="mt-1.5">Độ tin cậy: {message.confidence === "high" ? "Cao" : "Trung bình"}</p>
          </details>
        ) : null}
      </article>
    </li>
  ...
  return (
    <div className="min-h-0 flex-1 overflow-y-auto bg-background-light px-4 py-5 sm:px-6">
      {conversation.handoffReason ? (
        <section className="mx-auto mb-5 max-w-2xl rounded-xl border border-amber-200 bg-amber-50 p-4" aria-label="Yêu cầu chuyển người thật">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-xs leading-5 text-amber-800">{conversation.handoffReason}</p>

  ...
  return (
    <span className="flex size-full items-center justify-center rounded-full bg-[#168AFF] text-white">
      <svg viewBox="0 0 16 16" className="size-[70%]" fill="none" aria-hidden>
        <path d="M2.2 8c0-3.2 2.5-5.6 5.8-5.6s5.8 2.4 5.8 5.6-2.5 5.6-5.8 5.6c-.6 0-1.2-.1-1.8-.3l-2.4 1.3.1-2.4A5.4 5.4 0 0 1 2.2 8Z" fill="currentColor" />
  ...
  return (
    <span className="flex size-full items-center justify-center rounded-full bg-[linear-gradient(145deg,#8B5CF6,#EC4899,#F59E0B)] text-white">
      <svg viewBox="0 0 16 16" className="size-[66%]" fill="none" aria-hidden>
        <rect x="2.3" y="2.3" width="11.4" height="11.4" rx="3.4" stroke="currentColor" strokeWidth="1.7" />
...
function ThreadsMark() {
  return (
    <span className="flex size-full items-center justify-center rounded-full bg-slate-950 text-[11px] font-black leading-none text-white" aria-hidden>
      @
    </span>
  );
}

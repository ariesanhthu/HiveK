...
const PLATFORM_STYLE: Record<SocialPlatformId, string> = {
  ...
  instagram: 'bg-[linear-gradient(135deg,#f9ce34,#ee2a7b_52%,#6228d7)] text-white',
...
export function SocialConnectForm({
  ...
  const [selectedPlatforms, setSelectedPlatforms] = useState<SocialPlatformId[]>(initialPlatforms);
      ...
      <div className='flex items-start gap-3'>
        ...
        <div>
          ...
          <p className='mt-1 text-xs leading-5 text-foreground-muted'>
            Có thể chọn nhiều kênh. Bước này chỉ ghi nhận thủ công, chưa mở kết nối OAuth.
          </p>
        </div>
      </div>

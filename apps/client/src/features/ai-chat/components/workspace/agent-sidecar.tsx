...
import { CalendarRange, ChevronRight, PanelRightClose, RotateCcw, Sparkles } from 'lucide-react';
          ...
          <div className='min-h-0 flex-1 overflow-y-auto overscroll-contain px-4 py-5'>
            <div className='rounded-2xl border border-amber-200 bg-[linear-gradient(135deg,#fffaf0,#ffffff)] p-4'>
              ...
              <p className='mt-2 text-xs leading-5 text-foreground-muted'>
                Chọn một hành động để mình đưa bạn đến đúng màn hình. Dữ liệu đã được điền sẵn, bạn
                chỉ cần kiểm tra, chỉnh sửa và xác nhận.
              </p>
              <Link

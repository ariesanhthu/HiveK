      ...
      <div className='relative w-full max-w-3xl'>
        <div className='mb-6 text-center sm:mb-8'>
          ...
          <p className='mx-auto mt-3 max-w-xl text-pretty text-sm leading-6 text-foreground-muted sm:text-[15px]'>
            Chọn một hành động nhanh hoặc nhập website, fanpage, tên thương hiệu ở ô chat bên dưới.
            Agent sẽ connect trước, sau đó mới tải các hồ sơ liên quan để bạn xác nhận.
          </p>
        </div>

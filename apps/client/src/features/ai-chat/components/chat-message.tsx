...
import { BRAND_TONE_OPTIONS, SOCIAL_PLATFORM_OPTIONS } from '@/features/ai-chat/data/ai-chat-data';
import type {
  AiChatAction,
    ...
    <article className='flex items-start gap-3 py-3 sm:gap-3.5'>
      ...
      <div className='min-w-0 flex-1'>
        ...
        {message.widget?.type === 'drive-form' && isDriveComplete
          ...
          : null}
        {message.widget?.type === 'setup-complete' ? <SetupCompleteCard /> : null}

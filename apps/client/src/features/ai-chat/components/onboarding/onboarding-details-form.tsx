    ...
    >
      ...
      <form onSubmit={submit} className="space-y-5 p-4 sm:p-5">
          ...
          >
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <label className="block text-xs font-bold text-foreground">
                ...
                <textarea
                  ...
                  onChange={(event) =>
                    update("targetAudiences", event.target.value)
                  }
            ...
            <label className="block text-xs font-bold text-foreground">
              ...
              <textarea
                ...
                onChange={(event) =>
                  update("brandVoiceNotes", event.target.value)
                }
        ...
        <div className="flex items-start gap-2 rounded-2xl border border-emerald-100 bg-emerald-50/70 p-3 text-xs leading-5 text-emerald-900">
          ...
          <span>
            HIVE-K chỉ tạo bản nháp hồ sơ, kênh, chiến lược và dashboard. Bạn sẽ
            duyệt lại trước khi dùng hoặc xuất bản.
          </span>
        </div>

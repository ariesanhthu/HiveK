    ...
    <div className="flex h-full items-center justify-center rounded-lg border border-dashed border-primary-soft bg-card p-8 text-center">
      <div>
        ...
        <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-foreground-muted">
          Hãy tạo chiến dịch đầu tiên để quản lý brief, content, lộ trình đăng bài
          và người tham gia.
        </p>
  ...
  return (
    <div className="mx-auto max-w-3xl rounded-lg border border-primary-soft bg-background-light p-4">
      ...
      <p className="mt-2 text-sm leading-6 text-foreground-muted">
        Kiểm tra trạng thái brief, content, lịch đăng và rủi ro trước khi chuyển sang
        bước lên bài tự động.
      </p>
          ...
          <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
            <div className="min-w-0">
              ...
              <p className="mt-1 text-xs leading-5 text-foreground-muted">
                Quản lý list chiến dịch, tracking tổng quan, content, ảnh, Q&A và
                người tham gia trước khi lên bài tự động.
              </p>
            </div>
                ...
                <>
                  ...
                  {activeTab === "participants" ? (
                    <ParticipantsTab
                      ...
                      onAddParticipant={(input) => addParticipant(selectedCampaign.id, input)}

            ...
            {filteredCandidates.length === 0
              ? (
                <p className='rounded-xl border border-primary-soft bg-muted px-4 py-6 text-center text-sm text-foreground-muted'>
                  Không có creator nào phù hợp với bộ lọc. Thử xóa bộ lọc hoặc mở rộng khoảng tìm
                  kiếm.
                </p>
              )
              : null}
                    ...
                    <div className='flex min-w-0 items-start gap-3'>
                      ...
                      <div className='min-w-0'>
                        <div className='flex flex-wrap items-center gap-2'>
                          ...
                          {isSelected ? <Badge variant='success'>Đã chọn</Badge> : null}
                        </div>

...
const PROMPT_TEMPLATES = [
  {
    label: 'D2C Lifestyle',
    content: 'Finding eco-conscious nano-influencers in the EU for sustainable fashion...',
  },
  {
    label: 'Mobile Gaming',
      ...
      <Card className='border-primary-soft bg-primary-soft'>
        ...
        <CardContent>
          <p className='text-sm text-foreground-muted'>
            Để có kết quả chính xác, hãy xác định rõ đối tượng mục tiêu và tiếng nói thương hiệu. AI
            ưu tiên creator có tương tác thật thay vì người theo dõi ảo.
          </p>
        </CardContent>
      </Card>

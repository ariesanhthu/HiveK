...
const SUMMER_GLOW: CampaignDetail = {
  ...
  brief: {
    ...
    audience: 'Nữ 18–35, Bắc Mỹ, mức độ quan tâm cao đối với sản phẩm hữu cơ.',
  ...
  return {
    ...
    creators: [
      ...
      },
      {
        id: 'x2',
        name: 'Mai Linh Trần',
        avatarUrl: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=96&h=96&fit=crop',
        reachLabel: '512k',
        engagementLabel: '5.2%',
        status: 'pending_post',
      },

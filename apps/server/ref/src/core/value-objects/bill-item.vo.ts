...
export interface BillItemProps {
	...
	price: number;
	taxPercent: number;
	creditRefundAmount: Optional<number>;
	purchaseType: EPurchaseType;
}

export class BillItemVO extends ValueObject<BillItemProps> {
	...
	get creditRefundAmount(): Optional<number> {
		return this.props.creditRefundAmount;
	}

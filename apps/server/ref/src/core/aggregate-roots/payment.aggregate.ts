...
import { PaymentCreatedEvent } from '../events';
import type { JsonRecord } from '@/shared/types';
import { EPaymentStatus } from '../enums';
import { type FieldChanges } from '../entities/payment-event.entity';
...
export class PaymentEntity extends AggregateRoot<PaymentProps> {
	...
	public static create(input: PaymentCreateProps): PaymentEntity {
		...
		// Emit PaymentCreatedEvent since this is a brand new payment
	...
	public get metadata(): JsonRecord {

...
export class PaymentTransactionEntity extends Entity<PaymentTransactionProps> {
	...
	public get providerRequest(): Optional<JsonRecord> {
	...
	public get providerResponse(): Optional<JsonRecord> {
	...
	public get metadata(): Optional<JsonRecord> {

...
export const ENTERPRISE_INVITATION_READ_SERVICE = Symbol('ENTERPRISE_INVITATION_READ_SERVICE');

export interface IEnterpriseInvitationReadService extends IBaseReadService<EnterpriseInvitationDto, EnterpriseInvitationFilterDto> {}

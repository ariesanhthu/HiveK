...
export const PAYMENT_PROVIDER_READ_SERVICE = Symbol('PAYMENT_PROVIDER_READ_SERVICE');

export interface IPaymentProviderReadService extends IBaseReadService<PaymentProviderResponseDto, PaymentProviderFilterDto> {

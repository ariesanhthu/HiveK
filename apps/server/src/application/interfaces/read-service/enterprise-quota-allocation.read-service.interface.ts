...
export interface IEnterpriseQuotaAllocationReadService extends IBaseReadService<
  EnterpriseQuotaAllocationResponseDto,
  EnterpriseQuotaAllocationFilterDto
> {
  findByOwnerId(
...
export const ENTERPRISE_QUOTA_ALLOCATION_READ_SERVICE = Symbol(
  'IEnterpriseQuotaAllocationReadService',
);

...
export const PaymentProviderReducedResponseSchema = z
  .object({
    id: z.string(),
    code: z.string(),
...
export const PaymentProviderResponseSchema =
  PaymentProviderReducedResponseSchema.extend({
...
export class PaymentProviderReducedResponseDto extends createZodDto(
  PaymentProviderReducedResponseSchema,
) {}
export class PaymentProviderResponseDto extends createZodDto(

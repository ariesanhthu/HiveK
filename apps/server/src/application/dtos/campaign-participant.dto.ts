...
export const CampaignOutputDtoSchema = z
  .object({
    id: z.string(),
    platformId: z.string(),
...
export const CampaignParticipantDtoSchema = z
  .object({
    id: z.string(),
    campaignId: z.string(),
...
export class CampaignParticipantDto extends createZodDto(
  CampaignParticipantDtoSchema,
) {

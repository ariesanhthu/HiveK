...
export const BillItemResponseSchema = z
  .object({
...
export const BillCalculateResponseSchema = z
  .object({
    items: z.array(BillItemResponseSchema),
    totalAmount: z.number(),
    taxAmount: z.number(),
...
export class BillCalculateResponseDto extends createZodDto(
  BillCalculateResponseSchema,
) {}

...
export const ProposalProductInputSchema = z.object({
...
export const ProposalVoucherInputSchema = z.object({
  code: z.string().min(1),
...
export const ProposalMediaSlideInputSchema = z.object({
...
export class ProposalCreateInputDto extends createZodDto(ProposalCreateInputSchema) {}

...
export const ProposalUpdateProductInputSchema = z
  .object({
...
export const ProposalUpdateVoucherInputSchema = z
  .object({
    code: z.string().min(1),
...
export const ProposalUpdateMediaSlideInputSchema = z
  .object({
...
export const ProposalUpdateInputSchema = z
  .object({
...
export class ProposalUpdateInputDto extends createZodDto(

...
export class SocialPageDisconnectHandler implements ICommandHandler<
    ...
    try {
      ...
      if (socialPage.enterpriseId !== command.enterpriseId) {
        throw new InvalidOperationException(
          'Unauthorized enterprise operation on page connection.',
        );
      }

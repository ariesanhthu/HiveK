...
export class ScheduledPostScheduleHandler implements ICommandHandler<ScheduledPostScheduleCommand, ScheduledPostDto> {
  constructor(
  ...
  async execute(command: ScheduledPostScheduleCommand): Promise<ScheduledPostDto> {

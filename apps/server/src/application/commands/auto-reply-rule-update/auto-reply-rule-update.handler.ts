...
export class AutoReplyRuleUpdateHandler implements ICommandHandler<AutoReplyRuleUpdateCommand, AutoReplyRuleDto> {
  constructor(
  ...
  async execute(command: AutoReplyRuleUpdateCommand): Promise<AutoReplyRuleDto> {

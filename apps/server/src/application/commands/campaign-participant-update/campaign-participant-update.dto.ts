...
export const CampaignOutputInputSchema = z
  .object({
...
export const CampaignParticipantUpdateInputSchema = z
  .object({
...
export class CampaignParticipantUpdateInputDto extends createZodDto(
  CampaignParticipantUpdateInputSchema,
) {}

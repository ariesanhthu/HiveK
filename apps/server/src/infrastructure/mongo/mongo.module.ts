...
import {
  ...
  EnterpriseQuotaAllocationSchema,
...
@Module({
  imports: [
    ...
    MongooseModule.forFeature([
      ...
      {
        name: EnterpriseInvitationModel.name,
        schema: EnterpriseInvitationSchema,
      },
      {
        name: EnterpriseQuotaAllocationModel.name,
        schema: EnterpriseQuotaAllocationSchema,
      },
    ]),
  ],
  providers: [

...
export type SocialPageCreateProps = Omit<
  SocialPageProps,
  'pictureUrl' | 'followerCount' | 'tokenExpiresAt' | 'webhookVerifyToken' | 'isActive' | 'createdAt' | 'updatedAt' | 'deleteAt' | 'deleteBy'
> & {
  pictureUrl?: Nullable<string>;
  followerCount?: Nullable<number>;
  tokenExpiresAt?: Nullable<Date>;
...
export class SocialPageRoot extends BaseAggregateRoot<SocialPageProps> {
  ...
  public static create(props: SocialPageCreateProps, id?: string): SocialPageRoot {
    const now = new Date();
  ...
  public static instantiate(id: string, props: SocialPageProps): SocialPageRoot {
  ...
  get pageName(): string { return this.props.pageName; }
  get pictureUrl(): Nullable<string> { return this.props.pictureUrl; }
  get followerCount(): Nullable<number> { return this.props.followerCount; }
  get encryptedToken(): string { return this.props.encryptedToken; }
  get tokenExpiresAt(): Nullable<Date> { return this.props.tokenExpiresAt; }
  get webhookVerifyToken(): string { return this.props.webhookVerifyToken; }
  get isActive(): boolean { return this.props.isActive; }
  get createdAt(): Date { return this.props.createdAt; }
  get updatedAt(): Date { return this.props.updatedAt; }
  get deleteAt(): Nullable<Date> { return this.props.deleteAt; }
  get deleteBy(): Nullable<string> { return this.props.deleteBy; }
  ...
  public updateToken(encryptedToken: string, tokenExpiresAt: Nullable<Date> = null): void {
    this.props.encryptedToken = encryptedToken;
    this.props.tokenExpiresAt = tokenExpiresAt;
    this.props.updatedAt = new Date();
  }

  public updatePageInfo(pageName: string, pictureUrl: Nullable<string> = null, followerCount: Nullable<number> = null): void {

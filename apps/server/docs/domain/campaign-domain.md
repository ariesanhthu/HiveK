...
*All participant command handlers fetch the parent `CampaignRoot` via the `CampaignRepository` and delegate mutations directly to the aggregate methods before saving.*
